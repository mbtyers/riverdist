...
**Converting XY data to river coordinates using `xy2segvert()` and `pointshp2segvert()`**
...
Spatial data can be read directly from a point shapefile using `pointshp2segvert()`, which returns the resulting river coordinates added to the data table from the point shapefile.
